...
if(req.files == undefined)
    ...
    else
    {
        ...
        doc.addPage().text("Generated by Crammer, A Qasim Wani product: https://github.com/QasimWani/Crammer", 50, 100);
        doc.end();
        files.forEach((path)=>{
            deleteFile(path);
        });
